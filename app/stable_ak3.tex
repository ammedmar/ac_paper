...
\subsection*{Moved from S2: The Stable Andrews--Curtis Conjecture}\label{sec:stable_ac}\anibal{I would move this to a section on its own after the classical comparison section, and afterwards move the appendix about $\AK(3)$ to follow this section.}
