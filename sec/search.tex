...
We find that greedy-search outperforms breadth-first search in the task of AC-trivializing Miller--Schupp presentations. %\autoref{fig:performance}
...
\]
This presentation is the same as $MS(1, y^{-1} x^n y x^{-n})$, which is AC-trivial by \autoref{t:ms1wt}. 
\end{proof}
