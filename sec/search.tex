...
In the remainder of this paper, we will refer to the presentations from the Miller-Schupp series, that were solved and unsolved by greedy search as ``GS-solved" and ``GS-unsolved" presentations, respectively.
