...
We applied the greedy and breadth first search algorithms to trivialize the length 25 presentation mentioned in \autoref{sec:stable_ac},\anibal{recall explicitly and remove reference to the stable AC conjecture subsection}
\[
\angles{ x, y \mid
