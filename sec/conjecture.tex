...
Andrews-Curtis conjecture has many known variants. \fixme{include references} We briefly explored one of these variants, namely the ``stable" or ``weak" Andrews-Curtis conjecture.
