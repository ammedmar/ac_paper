...
While $\AK(3)$ is itself not a member of the family of examples studied by Bridson and Lishak, their findings challenge the inclination to view it as a counterexample.
...
Additionally, we reduced $x^{-1}w$ freely and cyclically and kept only one representative of each orbit under the action of a cyclic group.\anibal{What is the action?}
