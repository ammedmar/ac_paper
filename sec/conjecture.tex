...
\footnote{In \cite{decidability}, it is proven that either Andrews-Curtis conjecture is false,
	...
	problem is known to be unsolvable. \fixme{Is Baumslag-Boone-Neumann the right reference
		for this?}} Previous approaches to studying this conjecture have made extensive use
