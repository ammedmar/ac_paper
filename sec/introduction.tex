...
%We compare the performance of Greedy Search (GS), Breadth First Search and Proximal Policy Optimization on the presentations of Miller-Schupp series with $n, \ \text{length}(w) \leq 7$ in \autoref{fig:performance}.
