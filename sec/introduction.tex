...
\begin{introtheorem}
        ...
        \begin{enumerate}[label=(\roman*)]
            ...
            \item $\MS(n, w_\star)$ for $w_\star = y^{-1} x y x^{-1}$, \anibal{What's the quantifier for \(n\)?}
...
\begin{introtheorem}\label{thm:MS}
	...
	\end{gather*}
\end{introtheorem}
\anibal{I could not find where this theorem was proven. Please update the cross-reference}
